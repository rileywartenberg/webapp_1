...
<form method="post" action="edit_customer">
    ...
    <p><label for="lastName">LAST NAME</label><br/><input type="text" name="lastName" id="lastName" value="${customer.lastName}" size="30"></p>
    <p><label for="firstName">FIRST NAME</label><br/><input type="text" name="firstName" id="firstName" value="${customer.firstName}" size="30"></p>
